        ...
        <footer>
            <div className="footer__container">
                    ...
                    <div className="footer__contact__container">
                        ...
                        <ul className="footer__contacts">
                            <li className="footer__contact">
                                <LocalPhoneIcon /> <span>+216 23 456 789</span>
                            </li>
                            <li className="footer__contact">
                                <EmailIcon /> <span>shop@pravi.com</span>
                            </li>
                            <li className="footer__contact">
                                <LocationOnIcon /> <span>Sfax, Tunisia</span>
                            </li>
                        </ul>
                    </div>
                ...
                <div className="fotter__copyright__container">
                    <ul className='nav'>
                        <li className="footer__copyright">©2022 PRAVI Ltd. |</li>
